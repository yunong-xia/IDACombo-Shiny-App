        ...
        #Making plots
          if(comboscore){
            ...
            #Subsetting to data at max doses of all drugs
              ...
              for(i in 1:length(drugsToAdd)){
                temp_doses <- collected_result$Drug2Dose[collected_result$Drug2 == drugsToAdd[i]]
              ...
              max_dose_data <- NULL
              for(i in 1:length(drugsToAdd)){
                max_dose_data <- rbind(max_dose_data, collected_result[collected_result$Drug1Dose == max_dose_selected_drug & collected_result$Drug2 == drugsToAdd[i] & collected_result$Drug2Dose == max_dose_drugsToAdd[i],])
              }
