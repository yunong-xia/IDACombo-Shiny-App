sideBar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Test Vs Control", tabName = "testVsControl",
             menuSubItem("Focused", tabName = "onlyOnePair"),
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      wellPanel(
        ...
        h4(HTML("Ling, A., Huang, R.S. Computationally predicting clinical drug combination efficacy with cancer cell line screens and independent drug action. <i>In Press</i>. (2020).")),
        h4(HTML("Xia, Y., Ling, A., Huang, R.S. An IDACombo based web application for predicting cancer drug combination efficacy. <i>In Preparation</i>. (2020).")),
        br(),
        h3("To cite use of the pre-provided datasets"),
        h4(HTML("Ling, A., Huang, R.S. Simplicity: a simple web interface to manipulate high-throughput cancer drug screening data. <i>In Preparation</i>. (2020).")),
        h4(HTML("We also need to specify that users should cite the original papers for each dataset.")),
      )
    ),
    ...
    mainPanel(
      ...
      wellPanel(
        ...
        h4("The \"Test Vs Control\" tab is used to generate and compare efficacy predictions for a pair of user-specified control and test treatments. Concentrations must be specified for each drug in each treatment. The \"Focused\" subtab allows you to easily make predictions for a single control/experimental treatment pair. The \"Batch Processing\" subtab allows you to upload a text file specifying multiple control/experimental treatments to be compared.")
      )
    )
  )
)
...
citationPage <- fluidPage(
  ...
  wellPanel(
    p(HTML("<b>Cite Us:</b>")),
    p(HTML("1. Xia, Y., Ling, A., Huang, R.S. An IDACombo based web application for predicting cancer drug combination efficacy. In Preparation. (2020).")),
    p(HTML("2. Ling, A. & Huang, R. S. Computationally predicting clinical drug combination efficacy with cancer cell line screens and independent drug action. Nat. Commun. 11, 1–13 (2020).")),
    p(HTML("3. Ling, A., Huang, R.S. Simplicity: a simple web interface to manipulate high-throughput cancer drug screening data. In Preparation. (2020)."))
  ),
  wellPanel(
    p(HTML("<b>CTRPv2:</b>")),
    p(HTML("1.	Basu, A. et al. An Interactive Resource to Identify Cancer Genetic and Lineage Dependencies Targeted by Small Molecules. <i>Cell</i> <b>154</b>, 1151â€“1161 (2013).")),
    p(HTML("2.	Seashore-Ludlow, B. et al. Harnessing Connectivity in a Large-Scale Small-Molecule Sensitivity Dataset. <i>Cancer Discov.</i> <b>5</b>, 1210â€“1223 (2015).")),
    p(HTML("3.	Rees, M. G. et al. Correlating chemical sensitivity and basal gene expression reveals mechanism of action. <i>Nat. Chem. Biol.</i> <b>12</b>, 109â€“116 (2016).")),
  ...
  wellPanel(
    ...
    p(HTML("1.	Iorio, F. et al. A Landscape of Pharmacogenomic Interactions in Cancer. <i>Cell</i> <b>166</b>, 740â€“754 (2016).")),
    p(HTML("2.	Yang, W. et al. Genomics of Drug Sensitivity in Cancer (GDSC): a resource for therapeutic biomarker discovery in cancer cells. <i>Nucleic Acids Res.</i> <b>41</b>, D955â€“D961 (2013).")),
    p(HTML("3.	Garnett, M. J. et al. Systematic identification of genomic markers of drug sensitivity in cancer cells. <i>Nature</i> <b>483</b>, 570â€“575 (2012).")),
    p(HTML("Visit their website at <a href=\"https://www.cancerrxgene.org/\">https://www.cancerrxgene.org/</a>."))
  ),
  wellPanel(
    p(HTML("<b>PRISM-Repurposing:</b>")),
    p(HTML("1.	Corsello, S. M. et al. Discovering the anti-cancer potential of non-oncology drugs by systematic viability profiling. <i>Nat. Cancer</i> <b>1</b>, 235â€“248 (2020).")),
